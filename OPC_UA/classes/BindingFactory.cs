...
namespace OPC_UA.classes
{
    public class BindingFactory
    {
        ...
        {
            table.Add(Utils.UriSchemeHttps, typeof(Opc.Ua.Bindings.UaHttpsChannelListener));
            table.Add(Utils.UriSchemeOpcTcp, typeof(Opc.Ua.Bindings.UaTcpChannelListener));
